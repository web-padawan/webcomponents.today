module.exports = {
  url: "api-design",
  header: "API Design",
  description: "Things to consider when designing, prototyping, and implementing reusable Web Components.",
  items: [
    {
    ...
    },
    {
      ...
      thumbnail: "devto.png",
      quote: "A few things to consider when selecting a third party Web Component for your project.",
    },
    {
